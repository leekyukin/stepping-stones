  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-header mx-auto flex h-32 max-w-md items-center justify-center">
      <div className="relative flex w-full items-center justify-center">
        <div className="absolute -left-12 bottom-0 flex rotate-90 justify-start gap-5">
          <button
            className="rounded-t-xl border-2 border-b-0 border-black bg-white p-3 font-medium"
            onClick={toggleMenu}
          >
            MENU
          </button>
